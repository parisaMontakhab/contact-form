      ...
      <form className="form-contact" onSubmit={handleSubmit}>
        ...
        <div className="mb-4">
          ...
          <div className="flex-box ">
            <div
              className={
                formData.radio === "General Enquiry"
                  ? "active-query"
                  : "radiodiv-form "
              }
            ...
            >
              <input
                ...
                onChange={handleChange}
              />
              <label className="radiolabel-form" htmlFor="radioGeneral">
                General Enquiry
              </label>
            </div>
            ...
            <div
              className={
                formData.radio === "Support Request"
                  ? "active-query"
                  : "radiodiv-form "
              }
            ...
            >
              <input
                ...
                onChange={handleChange}
              />
              <label htmlFor="radioSupport" className="radiolabel-form">
                Support Request
              </label>
            </div>
          </div>
